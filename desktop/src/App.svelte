...
<div class="absolute top-0 w-full transition h-full bg-gray-800 z-20">
  <button class="absolute top-5 right-5" on:click={() => export_modal = false}>
  ...
  <div class="flex flex-row flex-wrap justify-center p-10">
    <button
      ...
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-1/2 h-1/2 mx-auto mt-3">
        <path stroke-linecap="round" stroke-linejoin="round" d="M21 7.5l-9-5.25L3 7.5m18 0l-9 5.25m9-5.25v9l-9 5.25M3 7.5l9 5.25M3 7.5v9l9 5.25m0-9v9" />
      </svg>
      Save .zip file
    </button>
    <button class="w-1/3 aspect-square m-3 bg-gray-500 rounded-md text-black text-center">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-1/2 h-1/2 mx-auto mt-3">
    ...
    <button class="w-1/3 aspect-square m-3 bg-gray-500 rounded-md text-black text-center">
      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 128 128" stroke-width="1.5" stroke="currentColor" class="w-1/2 h-1/2 mx-auto mt-3">
...
{/if}
  ...
  >
    ...
    />
    <button class="bg-blue-600 hover:scale-105 active:scale-100 rounded p-2 mb-2" type="submit">
      Add Link
    </button>
  </form>
    ...
    <div class="flex flex-col justify-start items-center">
      {#each links as link}
        <div class="flex-row w-3/4 p-3 m-2 bg-gray-700 rounded-md">
          <button class="relative float-right top-0 right-0 hover:scale-125 active:scale-100" on:click={() => removeLink(link.url, link.text)}>
